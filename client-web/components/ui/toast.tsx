...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-xl border border-border p-4 pr-8 shadow-2xl",
  {
    variants: {
      variant: {
        default: "bg-white dark:bg-dark-800 border",
        success:
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "transition-colors hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring",
